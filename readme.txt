...
* Theme: ["Wootique" (free, by WooThemes)](http://www.woothemes.com/woomember/go?r=130284&redirect=www.woothemes.com/2011/09/wootique/)
* Theme: ["Woostore"](http://www.woothemes.com/woomember/go?r=130284&redirect=www.woothemes.com/2011/09/woostore/) (thanks to Dusan Belescak)
...
= More =
* [Also see my other plugins](http://www.foxrunsoftware.com) or see [my WordPress.org profile page](http://profiles.wordpress.org/foxrunsoftware/)
...
= 1.1.0 - 2012.04.23 =
 * Shortcodes enabled for tab content

= 1.0.3 - 2012.03.19 =
 * Tab content textarea is larger for easier input

= 1.0.2 - 2012.03.19 =
 * Fixes an admin bug introduced by the 1.0.1 release (thanks to Cabbola)

= 1.0.1 - 2012.03.15 =
 * Fixes T_PAAMAYIM_NEKUDOTAYIM error (thanks daveshine)
